...
public:
	...
	friend GDONUSService &GetLockGDONUSService();
	static GDONUSService sInstance;
...
private:
	...
	std::array<bt_data, 3> mAdvertisingItems;
...
inline GDONUSService &GetGDONUSService()
{
	return GDONUSService::sInstance;
}
